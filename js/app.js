(() => {
    ...
    function initSliders() {
        if (document.querySelector(".choise__slider")) new core(".choise__slider", {
            ...
            lazy: true,
            navigation: {
                prevEl: ".choise-button-prev",
                nextEl: ".choise-button-next"
            },
            on: {}
        });
    }
    ...
    window.addEventListener("scroll", (() => {
        ...
        let pixelHeader = 150;
        if (window.innerWidth > 768) document.querySelectorAll("section").forEach(((el, i) => {
            if (el.offsetTop - document.querySelector(".menu__body").clientHeight <= scrollDistance + pixelHeader) {
    ...
    let userIcon = document.querySelector(".header__search-text");
    let userMenu = document.querySelector(".header__search-form");
    userIcon.addEventListener("click", (function(e) {
        userMenu.classList.toggle("_active");
    }));
    document.addEventListener("click", (function(e) {
        if (!e.target.closest(".header__search")) userMenu.classList.remove("_active");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
